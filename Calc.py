...
screen=Entry(root,width=50,fg="black", bg="white",borderwidth=10, text=scvalue, font=" Helvetica 40 bold")
screen.pack(padx=80, pady=10)

#Frames and buttons

frame=Frame(root,bg="black")

button=Button(frame,text='C',bg='gray67',fg='black' ,font="Helvetica 32",padx=12,pady=5)
...
button=Button(frame,text='/',bg='DarkGoldenrod1',fg='white' ,font="Helvetica 32",padx=18,pady=5)
button.pack(side=LEFT,padx=9,pady=10)
button.bind("<Button-1>",click)
...
button=Button(frame,text='*',bg='DarkGoldenrod1',fg='white' ,font="Helvetica 35",padx=13,pady=5)
button.pack(side=LEFT,padx=12,pady=18)
button.bind("<Button-1>",click)
...
button=Button(frame,text='4',bg='gray25',fg='white' ,font="Helvetica 35",padx=12,pady=5)
button.pack(side=LEFT,padx=12,pady=18)
button.bind("<Button-1>",click)
...
button.pack(side=LEFT,padx=16,pady=18)
button.bind("<Button-1>",click)
